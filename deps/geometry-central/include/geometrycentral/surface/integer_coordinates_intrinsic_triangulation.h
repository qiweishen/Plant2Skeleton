...
namespace geometrycentral {
	namespace surface {
		...
		public:
			...
			IntegerCoordinatesIntrinsicTriangulation(ManifoldSurfaceMesh& mesh, IntrinsicGeometryInterface& inputGeom, double mollifyEPS = 1e-5);
			...
			std::pair<bool, NormalCoordinatesCurve> traceNextCurve(const NormalCoordinatesCurve& oldCurve, bool verbose = false) const;
