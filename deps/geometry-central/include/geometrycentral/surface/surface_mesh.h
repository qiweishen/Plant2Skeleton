...
namespace geometrycentral {
	namespace surface {
		...
		public:
			...
			SurfaceMesh(const std::vector<std::vector<size_t>>& polygons, const std::vector<std::vector<std::tuple<size_t, size_t>>>& twins);
		...
		protected:
			...
			SurfaceMesh(const std::vector<size_t>& heNextArr, const std::vector<size_t>& heVertexArr, const std::vector<size_t>& heFaceArr,
						const std::vector<size_t>& vHalfedgeArr, const std::vector<size_t>& fHalfedgeArr, const std::vector<size_t>& heSiblingArr,
						const std::vector<size_t>& heEdgeArr, const std::vector<char>& heOrientArr, const std::vector<size_t>& eHalfedgeArr,
			...
			void generateVertexIterationCache(std::vector<size_t>& vertexIterationCacheHeIndex, std::vector<size_t>& vertexIterationCacheVertexStart,
											  bool incoming, bool skipDead = true);
