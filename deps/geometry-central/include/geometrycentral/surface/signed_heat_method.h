...
#define SHM_H
	...
	namespace surface {
		...
		public:
			...
			VertexData<double> computeDistance(const std::vector<Curve>& curves, const SignedHeatOptions& options = SignedHeatOptions());
		...
		private:
			...
			// Helpers
			Vector<std::complex<double>> integrateVectorHeatFlow(const std::vector<Curve>& curves, const std::vector<SurfacePoint>& points,
