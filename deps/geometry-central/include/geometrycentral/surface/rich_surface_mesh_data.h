...
namespace geometrycentral {
	namespace surface {
		...
		public:
			...
			static std::tuple<std::unique_ptr<SurfaceMesh>, std::unique_ptr<RichSurfaceMeshData>> readMeshAndData(std::string filename);
			static std::tuple<std::unique_ptr<SurfaceMesh>, std::unique_ptr<RichSurfaceMeshData>> readMeshAndData(std::istream& in);
			static std::tuple<std::unique_ptr<ManifoldSurfaceMesh>, std::unique_ptr<RichSurfaceMeshData>> readManifoldMeshAndData(
					std::string filename);
			static std::tuple<std::unique_ptr<ManifoldSurfaceMesh>, std::unique_ptr<RichSurfaceMeshData>> readManifoldMeshAndData(std::istream& in);
