	...
	namespace surface {
		...
		public:
			...
			void propagate(const SurfacePoint& source, double max_propagation_distance = GEODESIC_INF,
						   const std::vector<SurfacePoint>& stop_points = {});
			void propagate(const Vertex& source, double max_propagation_distance = GEODESIC_INF, const std::vector<Vertex>& stop_points = {});
		...
		protected:
			...
			void construct_propagated_intervals(bool invert, Halfedge halfedge, IntervalWithStop* candidates, unsigned& num_candidates,
			...
			const_interval_pointer best_first_interval(const SurfacePoint& point, double& best_total_distance, double& best_interval_position,
			...
			void best_point_on_the_edge_set(const SurfacePoint& point, std::vector<Edge> const& storage, const_interval_pointer& best_interval,
											double& best_total_distance, double& best_interval_position, bool verbose = false) const;
