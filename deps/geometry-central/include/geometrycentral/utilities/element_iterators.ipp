namespace geometrycentral {
	...
	template<typename F>
	RangeSetBase<F>::RangeSetBase(typename F::ParentMeshT* mesh_, size_t iStart_, size_t iEnd_) : mesh(mesh_), iStart(iStart_), iEnd(iEnd_) {}
	...
	template<typename N>
	inline NavigationIteratorBase<N>::NavigationIteratorBase(typename N::Etype e, bool justStarted_) : state{ e }, justStarted(justStarted_) {
	...
	template<typename N>
	NavigationSetBase<N>::NavigationSetBase(typename N::Etype firstE_) : firstE(firstE_), cachedEndIter{ NavigationIteratorBase<N>(firstE, false) } {}
