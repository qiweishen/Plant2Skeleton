...
namespace geometrycentral {
	...
	inline Vector2 normalizeCutoff(const Vector2& v, double mag) {
		return v.normalizeCutoff(mag);
	}
	...
	inline Vector2 Vector2::rotate90() const {
		return Vector2{ -y, x };
	}
	...
	inline Vector2 Vector2::conj() const {
		return Vector2{ x, -y };
	}

	inline Vector2 Vector2::inv() const {
		return Vector2{ 1., 0. } / *this;
	}

	inline double Vector2::arg() const {
		return std::atan2(y, x);
	}
	inline double arg(const Vector2& v) {
	...
	inline double Vector2::norm2() const {
		return x * x + y * y;
	}
	...
	inline Vector3 cross3(const Vector2& u, const Vector2& v) {
	...
	inline bool isDefined(const Vector2& v) {
		return v.isDefined();
	}
	...
	inline double sum(const Vector2& u) {
		return u.x + u.y;
	}
