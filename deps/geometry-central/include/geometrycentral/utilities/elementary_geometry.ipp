...
namespace geometrycentral {
	...
	inline double pointLineSegmentDistance(Vector2 p, Vector2 lineA, Vector2 lineB) {
		...
		if (len2 == 0.0)
			return (lineA - p).norm();									 // degenerate line case
	...
	inline SegmentSegmentIntersectionResult2D segmentSegmentIntersection(Vector2 pAStart, Vector2 pAEnd, Vector2 pBStart, Vector2 pBEnd) {
	...
	inline RaySegmentIntersectionResult2D raySegmentIntersection(Vector2 rayStart, Vector2 rayDir, Vector2 lineStart, Vector2 lineEnd) {
	...
	inline RayRayIntersectionResult2D rayRayIntersection(Vector2 ray1Start, Vector2 ray1Dir, Vector2 ray2Start, Vector2 ray2Dir) {
	...
	inline Vector3 tetFourthPoint(const Vector3& a, const Vector3& b, const Vector3& c, double Lad, double Lbd, double Lcd) {
