namespace geometrycentral {
	...
	inline double Vector3::norm2() const {
		return x * x + y * y + z * z;
	}
	...
	inline Vector3 normalizeCutoff(const Vector3& v, double mag) {
	...
	inline double sum(const Vector3& u) {
		return u.x + u.y + u.z;
	}
	...
	inline bool isDefined(const Vector3& v) {
		return v.isDefined();
	}
	...
	inline Vector3 Vector3::removeComponent(const Vector3& unitDir) const {
		return *this - unitDir * dot(unitDir, *this);
	}
