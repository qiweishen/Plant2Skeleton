...
BaseGeometryInterface::BaseGeometryInterface(SurfaceMesh& mesh_)
...

  {
		...
		// Vertex indices
		void BaseGeometryInterface::computeVertexIndices() {
			vertexIndices = mesh.getVertexIndices();
		}
		void BaseGeometryInterface::requireVertexIndices() {
			vertexIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireVertexIndices() {
			vertexIndicesQ.unrequire();
		}

		// Interior vertex indices
		void BaseGeometryInterface::computeInteriorVertexIndices() {
			interiorVertexIndices = mesh.getInteriorVertexIndices();
		}
		void BaseGeometryInterface::requireInteriorVertexIndices() {
			interiorVertexIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireInteriorVertexIndices() {
			interiorVertexIndicesQ.unrequire();
		}

		// Edge indices
		void BaseGeometryInterface::computeEdgeIndices() {
			edgeIndices = mesh.getEdgeIndices();
		}
		void BaseGeometryInterface::requireEdgeIndices() {
			edgeIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireEdgeIndices() {
			edgeIndicesQ.unrequire();
		}

		// Halfedge indices
		void BaseGeometryInterface::computeHalfedgeIndices() {
			halfedgeIndices = mesh.getHalfedgeIndices();
		}
		void BaseGeometryInterface::requireHalfedgeIndices() {
			halfedgeIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireHalfedgeIndices() {
			halfedgeIndicesQ.unrequire();
		}

		// Corner indices
		void BaseGeometryInterface::computeCornerIndices() {
			cornerIndices = mesh.getCornerIndices();
		}
		void BaseGeometryInterface::requireCornerIndices() {
			cornerIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireCornerIndices() {
			cornerIndicesQ.unrequire();
		}


		// Face indices
		void BaseGeometryInterface::computeFaceIndices() {
			faceIndices = mesh.getFaceIndices();
		}
		void BaseGeometryInterface::requireFaceIndices() {
			faceIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireFaceIndices() {
			faceIndicesQ.unrequire();
		}


		// Boundary loop indices
		void BaseGeometryInterface::computeBoundaryLoopIndices() {
			boundaryLoopIndices = mesh.getBoundaryLoopIndices();
		}
		void BaseGeometryInterface::requireBoundaryLoopIndices() {
			boundaryLoopIndicesQ.require();
		}
		void BaseGeometryInterface::unrequireBoundaryLoopIndices() {
			boundaryLoopIndicesQ.unrequire();
		}
