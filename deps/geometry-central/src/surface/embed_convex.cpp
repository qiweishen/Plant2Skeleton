...
namespace geometrycentral {
	namespace surface {
		...
		EmbedConvexResult embedConvex(ManifoldSurfaceMesh& triangulation, EdgeData<double>& edgeLengths, EmbedConvexOptions options) {
			...
			result.geometry =
					unique_ptr<VertexPositionGeometry>(new VertexPositionGeometry(*result.mesh, embedder.embedding.reinterpretTo(*result.mesh)));
		...
		EmbedConvexResult embedConvex(ManifoldSurfaceMesh& triangulation, IntrinsicGeometryInterface& intrinsicGeometry, EmbedConvexOptions options) {
			EmbedConvexResult result;
		...
		ConvexEmbedder::ConvexEmbedder(ManifoldSurfaceMesh& triangulation, EdgeData<double>& edgeLengths, EmbedConvexOptions embedderOptions) :
