...
namespace geometrycentral {
	namespace surface {
		...
		VertexData<Vector2> computeSmoothestBoundaryAlignedVertexDirectionField(IntrinsicGeometryInterface& geometry, int nSym) {
			SurfaceMesh& mesh = geometry.mesh;
		...
		FaceData<int> computeFaceIndex(IntrinsicGeometryInterface& geometry, const VertexData<Vector2>& directionField, int nSym) {
			SurfaceMesh& mesh = geometry.mesh;
		...
		VertexData<int> computeVertexIndex(IntrinsicGeometryInterface& geometry, const FaceData<Vector2>& directionField, int nSym) {
			SurfaceMesh& mesh = geometry.mesh;
