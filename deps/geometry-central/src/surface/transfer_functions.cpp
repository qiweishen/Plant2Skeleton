...
namespace geometrycentral {
	namespace surface {
		...
		VertexData<double> transferAtoB(CommonSubdivision& cs, VertexPositionGeometry& geomA, const VertexData<double>& valuesOnA,
		...
		VertexData<double> transferBtoA(CommonSubdivision& cs, VertexPositionGeometry& geomA, const VertexData<double>& valuesOnB,
										TransferMethod method) {
			AttributeTransfer transfer(cs, geomA);
