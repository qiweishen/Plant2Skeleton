...
namespace geometrycentral {
	namespace surface {
		...
		double Quadric::cost(const Eigen::Vector3d& v) {
			return v.dot(A * v) + 2 * b.dot(v) + c;
		}

		Eigen::Vector3d Quadric::optimalPoint() {
		...
		Quadric operator+(const Quadric& Q1, const Quadric& Q2) {
			return Quadric(Q1.A + Q2.A, Q1.b + Q2.b, Q1.c + Q2.c);
		}
