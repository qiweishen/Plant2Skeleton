...
namespace geometrycentral {
	namespace surface {
		...
		std::tuple<std::unique_ptr<ManifoldSurfaceMesh>, std::unique_ptr<VertexPositionGeometry>> makeHalfedgeAndGeometry(
		...
		std::tuple<std::unique_ptr<SurfaceMesh>, std::unique_ptr<VertexPositionGeometry>> makeGeneralHalfedgeAndGeometry(
				const std::vector<std::vector<size_t>>& polygons, const std::vector<Vector3> vertexPositions) {
