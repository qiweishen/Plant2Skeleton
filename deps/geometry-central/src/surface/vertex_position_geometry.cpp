...
namespace geometrycentral {
	namespace surface {
		...
		VertexPositionGeometry::VertexPositionGeometry(SurfaceMesh& mesh_) : EmbeddedGeometryInterface(mesh_), inputVertexPositions(vertexPositions) {
