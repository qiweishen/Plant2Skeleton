...
namespace geometrycentral {
	namespace surface {
		...
		PoissonDiskSampler::PoissonDiskSampler(ManifoldSurfaceMesh& mesh_, VertexPositionGeometry& geometry_) : mesh(mesh_), geometry(geometry_) {
		 ...
		 */
		void PoissonDiskSampler::addPointToSpatialLookupWithRadius(const SurfacePoint& newPoint, double radius, bool use3DAvoidance) {
