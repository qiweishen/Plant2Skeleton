...
IntrinsicGeometryInterface::IntrinsicGeometryInterface(SurfaceMesh& mesh_) : 
  ...
  { }
		...
		void IntrinsicGeometryInterface::requireEdgeLengths() {
			edgeLengthsQ.require();
		}
		void IntrinsicGeometryInterface::unrequireEdgeLengths() {
			edgeLengthsQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::unrequireFaceAreas() {
			faceAreasQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireVertexDualAreas() {
			vertexDualAreasQ.require();
		}
		void IntrinsicGeometryInterface::unrequireVertexDualAreas() {
			vertexDualAreasQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireCornerAngles() {
			cornerAnglesQ.require();
		}
		void IntrinsicGeometryInterface::unrequireCornerAngles() {
			cornerAnglesQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireVertexAngleSums() {
			vertexAngleSumsQ.require();
		}
		void IntrinsicGeometryInterface::unrequireVertexAngleSums() {
			vertexAngleSumsQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireCornerScaledAngles() {
			cornerScaledAnglesQ.require();
		}
		void IntrinsicGeometryInterface::unrequireCornerScaledAngles() {
			cornerScaledAnglesQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireVertexGaussianCurvatures() {
			vertexGaussianCurvaturesQ.require();
		}
		void IntrinsicGeometryInterface::unrequireVertexGaussianCurvatures() {
			vertexGaussianCurvaturesQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireFaceGaussianCurvatures() {
			faceGaussianCurvaturesQ.require();
		}
		void IntrinsicGeometryInterface::unrequireFaceGaussianCurvatures() {
			faceGaussianCurvaturesQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireHalfedgeCotanWeights() {
			halfedgeCotanWeightsQ.require();
		}
		void IntrinsicGeometryInterface::unrequireHalfedgeCotanWeights() {
			halfedgeCotanWeightsQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireEdgeCotanWeights() {
			edgeCotanWeightsQ.require();
		}
		void IntrinsicGeometryInterface::unrequireEdgeCotanWeights() {
			edgeCotanWeightsQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireShapeLengthScale() {
			shapeLengthScaleQ.require();
		}
		void IntrinsicGeometryInterface::unrequireShapeLengthScale() {
			shapeLengthScaleQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireMeshLengthScale() {
			meshLengthScaleQ.require();
		}
		void IntrinsicGeometryInterface::unrequireMeshLengthScale() {
			meshLengthScaleQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireHalfedgeVectorsInFace() {
			halfedgeVectorsInFaceQ.require();
		}
		void IntrinsicGeometryInterface::unrequireHalfedgeVectorsInFace() {
			halfedgeVectorsInFaceQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireTransportVectorsAcrossHalfedge() {
			transportVectorsAcrossHalfedgeQ.require();
		}
		...
		void IntrinsicGeometryInterface::requireHalfedgeVectorsInVertex() {
			halfedgeVectorsInVertexQ.require();
		}
		void IntrinsicGeometryInterface::unrequireHalfedgeVectorsInVertex() {
			halfedgeVectorsInVertexQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireTransportVectorsAlongHalfedge() {
			transportVectorsAlongHalfedgeQ.require();
		}
		...
		void IntrinsicGeometryInterface::requireCotanLaplacian() {
			cotanLaplacianQ.require();
		}
		void IntrinsicGeometryInterface::unrequireCotanLaplacian() {
			cotanLaplacianQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireVertexLumpedMassMatrix() {
			vertexLumpedMassMatrixQ.require();
		}
		void IntrinsicGeometryInterface::unrequireVertexLumpedMassMatrix() {
			vertexLumpedMassMatrixQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireVertexGalerkinMassMatrix() {
			vertexGalerkinMassMatrixQ.require();
		}
		void IntrinsicGeometryInterface::unrequireVertexGalerkinMassMatrix() {
			vertexGalerkinMassMatrixQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireFaceGalerkinMassMatrix() {
			faceGalerkinMassMatrixQ.require();
		}
		void IntrinsicGeometryInterface::unrequireFaceGalerkinMassMatrix() {
			faceGalerkinMassMatrixQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireVertexConnectionLaplacian() {
			vertexConnectionLaplacianQ.require();
		}
		void IntrinsicGeometryInterface::unrequireVertexConnectionLaplacian() {
			vertexConnectionLaplacianQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireFaceConnectionLaplacian() {
			faceConnectionLaplacianQ.require();
		}
		void IntrinsicGeometryInterface::unrequireFaceConnectionLaplacian() {
			faceConnectionLaplacianQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireCrouzeixRaviartLaplacian() {
			crouzeixRaviartLaplacianQ.require();
		}
		void IntrinsicGeometryInterface::unrequireCrouzeixRaviartLaplacian() {
			crouzeixRaviartLaplacianQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireCrouzeixRaviartMassMatrix() {
			crouzeixRaviartMassMatrixQ.require();
		}
		void IntrinsicGeometryInterface::unrequireCrouzeixRaviartMassMatrix() {
			crouzeixRaviartMassMatrixQ.unrequire();
		}
		...
		void IntrinsicGeometryInterface::requireDECOperators() {
			DECOperatorsQ.require();
		}
		void IntrinsicGeometryInterface::unrequireDECOperators() {
			DECOperatorsQ.unrequire();
		}
