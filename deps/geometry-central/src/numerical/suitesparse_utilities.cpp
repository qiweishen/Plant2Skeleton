...
namespace geometrycentral {
	...
	// === Context
	CholmodContext::CholmodContext(void) {
	...
	void CholmodContext::setSimplicial(void) {
		context.supernodal = CHOLMOD_SIMPLICIAL;
	}

	void CholmodContext::setSupernodal(void) {
		context.supernodal = CHOLMOD_SUPERNODAL;
	}

	void CholmodContext::setLL(void) {
		context.final_ll = true;
	}

	void CholmodContext::setLDL(void) {
		context.final_ll = false;
	}


	CholmodContext::operator cholmod_common*(void) {
		return &context;
	}
