...
PointPositionGeometry::PointPositionGeometry(PointCloud& cloud_, const PointData<Vector3>& positions_)
...

  {
		...
		PointPositionGeometry::PointPositionGeometry(PointCloud& cloud_) : PointPositionGeometry(cloud_, PointData<Vector3>(cloud_)) {}
		...
		// Point indices
		void PointPositionGeometry::computePointIndices() {
			pointIndices = cloud.getPointIndices();
		}
		void PointPositionGeometry::requirePointIndices() {
			pointIndicesQ.require();
		}
		void PointPositionGeometry::unrequirePointIndices() {
			pointIndicesQ.unrequire();
		}

		// Neighbors
		void PointPositionGeometry::computeNeighbors() {
			neighbors.reset(new Neighborhoods(cloud, positions, kNeighborSize));
		}
		void PointPositionGeometry::requireNeighbors() {
			neighborsQ.require();
		}
		void PointPositionGeometry::unrequireNeighbors() {
			neighborsQ.unrequire();
		}
		...
		void PointPositionGeometry::unrequireNormals() {
			normalsQ.unrequire();
		}
		...
		void PointPositionGeometry::requireTangentBasis() {
			tangentBasisQ.require();
		}
		void PointPositionGeometry::unrequireTangentBasis() {
			tangentBasisQ.unrequire();
		}
		...
		void PointPositionGeometry::requireTangentCoordinates() {
			tangentCoordinatesQ.require();
		}
		void PointPositionGeometry::unrequireTangentCoordinates() {
			tangentCoordinatesQ.unrequire();
		}
		...
		void PointPositionGeometry::requireTangentTransport() {
			tangentTransportQ.require();
		}
		void PointPositionGeometry::unrequireTangentTransport() {
			tangentTransportQ.unrequire();
		}
		...
		void PointPositionGeometry::requireTuftedTriangulation() {
			tuftedTriangulationQ.require();
		}
		void PointPositionGeometry::unrequireTuftedTriangulation() {
			tuftedTriangulationQ.unrequire();
		}
		...
		void PointPositionGeometry::unrequireLaplacian() {
			laplacianQ.unrequire();
		}
		...
		void PointPositionGeometry::requireConnectionLaplacian() {
			connectionLaplacianQ.require();
		}
		void PointPositionGeometry::unrequireConnectionLaplacian() {
			connectionLaplacianQ.unrequire();
		}
		...
		void PointPositionGeometry::unrequireGradient() {
			gradientQ.unrequire();
		}
