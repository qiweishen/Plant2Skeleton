...
namespace easy3d {
	...
	namespace io {
		...
		/// \brief A general purpose Binary file reader
		...
		public:
            ...
            /**
             * \brief Reads a Binary file and stores the model as a set of \p elements.
             ...
             * 		  a Binary file stores a point cloud, a graph, or a surface mesh. Internally it reads the ply file
		...
		/// \brief A general purpose Binary file writer.
		/// \details This class is internally used by PointCloudIO, SurfaceMeshIO, and GraphIO.
		/// Client code should use PointCloudIO, SurfaceMeshIO, and GraphIO.
