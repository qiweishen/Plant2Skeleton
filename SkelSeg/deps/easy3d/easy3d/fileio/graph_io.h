...
namespace easy3d {
    ...
    /// \brief Implementation of file input/output operations for Graph (Currently only Binary format is supported).
	...
	public:
         ...
         * \details File extension determines file format (currently only Binary format is supported).
         */
    ...
    namespace io {
        ...
        /**
         * \brief Loads \p graph from a Binary file \p file_name.
         * \return The status of the operation
         *      \arg true if succeeded
         *      \arg false if failed
         */
        ...
        /**
         * \brief Saves \p graph into a Binary file \p file_name.
