...
BOOL LASreaderMerged::add_file_name(const CHAR* file_name)
{
  ...
  if (strstr(file_name, ".las") || strstr(file_name, ".laz") || strstr(file_name, ".LAS") || strstr(file_name, ".LAZ"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with LAS. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
  ...
  else if (strstr(file_name, ".bin") || strstr(file_name, ".BIN"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with BIN. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
  ...
  else if (strstr(file_name, ".shp") || strstr(file_name, ".SHP"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with SHP. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
  ...
  else if (strstr(file_name, ".asc") || strstr(file_name, ".ASC"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with ASC. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
  ...
  else if (strstr(file_name, ".bil") || strstr(file_name, ".BIL"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with BIL. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
  ...
  else if (strstr(file_name, ".dtm") || strstr(file_name, ".DTM"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with DTM. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
  ...
  else if (strstr(file_name, ".ply") || strstr(file_name, ".Binary"))
  {
    if (lasreaderlas)
    {
      fprintf(stderr, "ERROR: cannot mix LAS with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderbin)
    {
      fprintf(stderr, "ERROR: cannot mix BIN with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreadershp)
    {
      fprintf(stderr, "ERROR: cannot mix SHP with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderasc)
    {
      fprintf(stderr, "ERROR: cannot mix ASC with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderbil)
    {
      fprintf(stderr, "ERROR: cannot mix BIL with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderdtm)
    {
      fprintf(stderr, "ERROR: cannot mix DTM with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
      fprintf(stderr, "ERROR: cannot mix QFIT with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreadertxt)
    {
      fprintf(stderr, "ERROR: cannot mix TXT with Binary. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderply == 0)
    {
  ...
  else if (strstr(file_name, ".qi") || strstr(file_name, ".QI"))
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with QFIT. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreadertxt)
    {
  ...
  else
  {
    ...
    if (lasreaderply)
    {
      fprintf(stderr, "ERROR: cannot mix Binary with TXT. skipping '%s' ...\n", file_name);
      return FALSE;
    }
    if (lasreaderqfit)
    {
