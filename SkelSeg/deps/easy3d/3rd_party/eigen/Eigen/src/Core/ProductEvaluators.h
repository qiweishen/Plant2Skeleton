...
/** \internal
  ...
  * we simply defer the evaluator logic to a product_evaluator class
...
// Depending on the sizes of the factors, there are different evaluator strategies
...
struct generic_product_impl<Lhs,Rhs,DenseShape,DenseShape,CoeffBasedProductMode> 
{
  ...
  // This is a special evaluator path called from generic_product_impl<...,GemmProduct> in file GeneralMatrixMatrix.h
...
// This specialization enforces the use of a coefficient-based evaluator strategy
template<typename Lhs, typename Rhs>
