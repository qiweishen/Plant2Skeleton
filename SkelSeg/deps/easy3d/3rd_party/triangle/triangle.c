...
/*    evaluator of the signs of determinants are taken from Steven Fortune  */
...
/********* User-defined triangle evaluator routine begins here      *********/
/**                                                                         **/
/**                                                                         **/
...
/**                                                                         **/
/**                                                                         **/
/********* User-defined triangle evaluator routine ends here        *********/
...

{
  ...
  foundvertex = (char *) (alignptr + (uint64_t) m->vertices.alignbytes -
...

{
  ...
  while (totalsamplesleft > 0) {
    ...
    firsttri = (char *) (alignptr +
                         (uint64_t) m->triangles.alignbytes -
                         (alignptr %
                          (uint64_t) m->triangles.alignbytes));
