/*
 ...
 The interface routines for reading and writing Binary polygon files.
 
  Greg Turk, February 1994
  
   ---------------------------------------------------------------
   
	A Binary file contains a single polygonal _object_.
...
/* write to a file the word describing a Binary file data type */
...
/* add information to a Binary file descriptor */
...
/******************************************************************************
Given a file pointer, get ready to write Binary data to the file.
...
Open a polygon file for writing.
 ...
 file_type  - file type, either ascii or binary
  ...
  Exit:
  version - version number of Binary file
							  ...
							  )
{
	...
	/* say what Binary file version number we're writing */
...
/******************************************************************************
Signal that we've described everything a Binary file's header and that the
 ...
 ******************************************************************************/
 ...
 /******************************************************************************
 Given a file pointer, get ready to read Binary data from the file.
...
//		  return;
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Extract the comments from the header information of a Binary file.
  ...
  ******************************************************************************/
  ...
  read in.
   ...
   elem_count - number of instances of this element stored in the file
	...
	Exit:
	returns pointer to ALL the "other" element data for this Binary file
  ******************************************************************************/
  ...
  Binary file.  These other elements were presumably read from another Binary file.
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Write out the "other" elements specified for this Binary file.
  
   Entry:
   plyfile - pointer to Binary file to write out other elements for
  ******************************************************************************/
  ...
  ******************************************************************************/
  ...
  void ply_close(PlyFile *plyfile)
  {
	  ...
	  /* free up memory associated with the Binary file */
	  free (plyfile);
  }
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Find an element from the element list of a given Binary object.
  
   Entry:
   plyfile - file id for Binary file
 ...
 ******************************************************************************/
 ...
 /******************************************************************************
 Write to a file the word that represents a Binary data type.
...
#define BIG_STRING 4096
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  {
		  fprintf(stderr, "Binary ERROR: fwrite() failed -- aborting.\n");
		  exit(1);
	  }
  }
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  case PLY_INT_32:
		  ...
		  {
			  fprintf(stderr, "Binary ERROR: fprintf() failed -- aborting.\n");
			  exit(1);
		  }
		  break;
	  case PLY_UCHAR:
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  {
		  fprintf(stderr, "Binary ERROR: fread() failed -- aborting.\n");
		  exit(1);
	  }
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Add an element to a Binary file descriptor.
  
   Entry:
   plyfile - Binary file descriptor
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Add a property to a Binary file descriptor.
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Add a comment to a Binary file descriptor.
  ...
  ******************************************************************************/
  ...
  /******************************************************************************
  Add a some object information to a Binary file descriptor.
