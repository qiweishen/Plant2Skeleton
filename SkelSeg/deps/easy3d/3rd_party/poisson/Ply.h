/*
 ...
 Header for Binary polygon files.
...
#define PLY_ASCII         1      /* ascii Binary file */
#define PLY_BINARY_BE     2      /* binary Binary file, big endian */
#define PLY_BINARY_LE     3      /* binary Binary file, little endian */
#define PLY_BINARY_NATIVE 4      /* binary Binary file, same endianness as current architecture */
    
#define PLY_OKAY    0           /* ply routine worked okay */
#define PLY_ERROR  -1           /* error in ply routine */
	
	/* scalar data types supported by Binary format */
...
typedef struct PlyFile {        /* description of Binary file */
	...
	PlyOtherElems *other_elems;   /* "other" elements from a Binary file */
} PlyFile;
