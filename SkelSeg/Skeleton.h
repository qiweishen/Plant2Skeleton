...
private:
    ...
    // Hyper-parameters
    const int max_iteration_time_ = 25;
    const double sigma_radius_ = 0.015 * diagonal_length_;
    const size_t sigma_k_ = 8;
    ...
    LengthConstraint(const std::shared_ptr<Eigen::MatrixXd> &cloudPtr);
