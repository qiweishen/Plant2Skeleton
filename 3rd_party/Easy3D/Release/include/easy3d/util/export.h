...
#      define EASY3D_UTIL_EXPORT __attribute__((visibility("default")))
#    else
...
#    define EASY3D_UTIL_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef EASY3D_UTIL_DEPRECATED
#  define EASY3D_UTIL_DEPRECATED __attribute__ ((__deprecated__))
#endif
